...
<div class="media-grid-2">
  {% include project-media.html type="image" src="collision_trigger.png" caption="Fig. 7  Example of collision-prone grasp poses generated by AnyGrasp due to missing side point cloud data of the box." muted=true autoplay=true loop=true%}
