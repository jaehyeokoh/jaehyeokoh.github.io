...
furthurmore the paper saids that to make a fine motion, we need fine tuning and do more train about that motion. but if llm can assembly the basic motion and we train pi_0 method only by grab, release, tilt, etc.. then it could be a efficient way.
